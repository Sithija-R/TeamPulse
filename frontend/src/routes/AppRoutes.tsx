    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<AppLayout />}>
          ...
          {/* User Routes (Accessible by Team Member, Manager, Admin) */}
          <Route element={<RoleRoute allowedRoles={['TEAM_MEMBER', 'MANAGER', 'ADMIN']} />}>
            ...
            <Route path="/user/reports/:id/versions" element={<ReportVersions />} />
            <Route path="/user/profile" element={<Profile />} />
          </Route>

          {/* Management Routes (Accessible only by Manager, Admin) */}
          <Route element={<RoleRoute allowedRoles={['MANAGER', 'ADMIN']} />}>
            <Route path="/management/dashboard" element={<ManagementDashboard />} />
            <Route path="/management/reports" element={<AllReports />} />
            <Route path="/management/reports/:id" element={<ManagementReportDetail />} />
            <Route path="/management/reports/:id/review" element={<ReviewReport />} />
            <Route path="/management/reports/:id/versions" element={<ManagementReportVersions />} />
            <Route path="/management/team" element={<TeamMembers />} />
            <Route path="/management/team/:id" element={<MemberProfile />} />
